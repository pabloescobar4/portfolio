  ...
  return (
    <Card className="project-card-view">
      ...
      <Card.Body>
        ...
        <span class="badge badge-info font-weight-lighter ml-1">React</span> 
        <span class="badge badge-secondary font-weight-lighter ml-1 ">Redux</span> 
      

        <Button variant="primary " href={props.link} target="_blank" className="ml-2 mt-4">
          
          <BiLinkExternal /> &nbsp;
          {props.isBlog ? "View Blog" : "Code"}
        </Button>

        <Button variant="primary " href={props.link1} target="_blank" className="ml-4 mt-4">
